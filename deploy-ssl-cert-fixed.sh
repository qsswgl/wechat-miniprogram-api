...
echo "📥 拉取修复版本镜像..."
docker pull 43.138.35.183:5000/wechat-api-net8:alpine-musl-ssl-cert-fixed

echo "🚀 启动新容器（SSL证书路径已修复）..."
docker run -d \
  --name wechat-api \
  ...
  43.138.35.183:5000/wechat-api-net8:alpine-musl-ssl-cert-fixed
